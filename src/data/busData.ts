...
export const workingDaysBus: BusSchedule = {
  ...
  palakkadTown: [
    ...
    { description: "Sahyadri 6:15 PM → Nila Gate → Pudussery → Kadamkode → Manapullykavu → Maidaan (Govt. Hospital) → Stadium Bus Stand → Palakkad 6:45 PM. Stadium Bus Stand 6:50 PM → Chandranagar → Pudussery → Nila." }
  ],
  wisePark: [
