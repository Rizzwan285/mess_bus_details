...
export const week1and3Menu: WeekMenu = {
  Monday: {
    ...
    Lunch: [{ meal: "Lunch", items: ["Phulka", "White Rice", "Kerala Rice", "Chana Masala", "Arhar Dal (Pigeon Pea)", "Curd"] }],
    Snacks: [{ meal: "Snacks", items: ["Onion Kachori", "Tomato Ketchup", "Fried Chilly"] }],
    Dinner: [{ meal: "Dinner", items: ["Phulka", "Dal Tadka", "Garlic Sauce"], nonVeg: "Egg Fried Rice", veg: "Gobhi Fried Rice" }]
  },
  Tuesday: {
    ...
    Snacks: [{ meal: "Snacks", items: ["Aloo Bonda", "Tomato Ketchup"] }],
    Dinner: [{ meal: "Dinner", items: ["Phulka", "Chole Masala", "Jeera Rice", "Dal", "Plain Raita", "Ice Cream"] }]
  },
  Wednesday: {
    Breakfast: [{ meal: "Breakfast", items: ["Dal Khichdi", "Coconut Chutney", "Dahi Boondi (Small Cup)", "Peanut Butter"], nonVeg: "Omelette" }],
    Lunch: [{ meal: "Lunch", items: ["Chapathi", "White Rice", "Green Peas Masala", "Tomato Rice", "Onion Raita (Thick)", "Rasam", "Chana Dal Fry"] }],
    Snacks: [{ meal: "Snacks", items: ["Masala Channa"] }],
    Dinner: [{ meal: "Dinner", items: ["White Rice", "Moong Dal", "Lachcha Paratha", "Laddu", "Lemon"], veg: "Hyderabadi Paneer Dish", nonVeg: "Hyderabadi Style Chicken Masala" }]
  },
  Thursday: {
    Breakfast: [{ meal: "Breakfast", items: ["Puri", "Chana Masala"] }],
    Lunch: [{ meal: "Lunch", items: ["Chapathi", "White Rice", "Mix Dal", "Gobhi Butter Masala", "Bottle Gourd Dry", "Curd"] }],
    Snacks: [{ meal: "Snacks", items: ["Tikki Chat"] }],
    Dinner: [{ meal: "Dinner", items: ["Sambar", "Masala Dosa (Unlimited)", "White Rice", "Tomato/Coriander Chutney", "Payasam", "Rasam"] }]
  },
  Friday: {
    ...
    Dinner: [{ meal: "Dinner", items: ["Pulao", "Mix Dal", "Chapathi", "Mango Pickle", "Lemon", "Jalebi"], nonVeg: "Chicken Gravy", veg: "Paneer Butter Masala" }]
  },
  Saturday: {
    ...
    Dinner: [{ meal: "Dinner", items: ["Phulka", "Green Peas Masala", "White Rice", "Brinjal Curry", "Rasam"] }]
  },
  Sunday: {
    Breakfast: [{ meal: "Breakfast", items: ["Onion Rava Dosa", "Tomato Chutney", "Sambar"] }],
    Lunch: [{ meal: "Lunch", items: ["Shorba Masala", "Onion Raita (Thick)", "Aam Panna"], nonVeg: "Chicken Dum Biryani", veg: "Paneer Dum Biryani" }],
...
export const week2and4Menu: WeekMenu = {
  Monday: {
    ...
    Lunch: [{ meal: "Lunch", items: ["Phulka", "Ghee Rice", "Aloo Chana Masala", "Soya Chilly", "Rasam", "Buttermilk"] }],
  ...
  Tuesday: {
    Breakfast: [{ meal: "Breakfast", items: ["Poha", "Coriander Chutney", "Curd"] }],
    Lunch: [{ meal: "Lunch", items: ["Chola Bhatura", "Toor Dal Fry", "Watermelon", "Aloo Bhindi (Dry)", "Lemon Rice", "Curd"] }],
    Snacks: [{ meal: "Snacks", items: ["Bread Pakoda with Sauce"] }],
    Dinner: [{ meal: "Dinner", items: ["Phulka", "White Rice", "Methi Dal", "Veg White Kurma", "Ice Cream"] }]
  },
  Wednesday: {
    ...
    Snacks: [{ meal: "Snacks", items: ["Grilled Sandwich", "Tomato Ketchup"] }],
    Dinner: [{ meal: "Dinner", items: ["Pulao", "Mix Dal", "Tawa Butter Naan", "Jalebi", "Mango Pickle", "Lemon"], nonVeg: "Kadai Chicken", veg: "Kadai Paneer" }]
  },
  Thursday: {
    ...
    Dinner: [{ meal: "Dinner", items: ["Phulka", "Baby Aloo Masala", "White Rice", "Thick Dal", "Rasam", "Halwa (Mix)"] }]
  },
  Friday: {
    Breakfast: [{ meal: "Breakfast", items: ["Dhal Dosa", "Sambar", "Tomato Chutney", "Peanut Butter"] }],
    Lunch: [{ meal: "Lunch", items: ["Phulka", "Navadhanya Masala", "Sambar", "Rasam", "Mix Veg Shahi Curry", "Watermelon Juice"] }],
    Snacks: [{ meal: "Snacks", items: ["Pani Puri"] }],
    Dinner: [{ meal: "Dinner", items: ["Pulao", "Mix Dal", "Chapathi", "Jalebi", "Mango Pickle", "Lemon"], nonVeg: "Chicken Gravy", veg: "Paneer Butter Masala" }]
  },
  Saturday: {
    Breakfast: [{ meal: "Breakfast", items: ["Mix-Veg Paratha", "Curd", "Ketchup"], nonVeg: "Omelette" }],
    ...
    Snacks: [{ meal: "Snacks", items: ["Samosa", "Tomato Ketchup", "Cold Coffee"] }],
    Dinner: [{ meal: "Dinner", items: ["Dal Makhani", "Gobhi Matar", "Phulka", "Tomato Rice", "Kheer"] }]
  },
  Sunday: {
